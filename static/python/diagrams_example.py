...
class DiagramsRenderer:
    ...
    def __init__(self):
        ...
        console.log("🐍 DiagramsRenderer initialized")
    ...
    def _patch_graphviz(self):
        ...
        class CaptureDigraph(renderer.original_digraph):
            ...
            def render(self, *args, **kwargs):
                ...
                console.log(f"🎯 Captured DOT from graphviz.Digraph: {len(dot_source)} bytes")
                console.log(f"📝 Filename: {filename}")
                console.log(f"📄 DOT source preview: {dot_source[:500]}")

                # Process icon paths and create mapping
                image_urls = renderer._extract_icon_urls(dot_source)
                console.log(f"✅ Found {len(image_urls)} unique images")

                # Determine chart ID
                if renderer.current_chart_id:
                    chart_id = renderer.current_chart_id
                    console.log(f"📊 Using preset chart ID: {chart_id}")
                else:
                    chart_id = f"chart{len(renderer.dot_outputs) + 1}"
                    console.log(f"📊 Auto-generated chart ID: {chart_id}")
        ...
        console.log("✅ graphviz.Digraph patched successfully")
        ...
        def collect_image_path(match):
            ...
            if '/resources/' in full_path or '\\resources\\' in full_path:
                ...
                if len(parts) > 1:
                    ...
                    console.log(f"🔄 Found image: {relative_path}")
    ...
    def _patch_subprocess(self):
        ...
        def mock_subprocess_run(args, **kwargs):
            ...
            if args and 'dot' in str(args[0]):
                console.log(f"🔧 Intercepting subprocess call: {args}")
        ...
        console.log("✅ subprocess.run patched successfully")
    ...
    def _load_diagrams_library(self) -> bool:
        ...
        try:
            ...
            console.log(f"📂 Diagrams library path: {diagrams_path}")

            resources_path = os.path.join(diagrams_path, "resources")
            if os.path.exists(resources_path):
                console.log(f"✅ Resources path exists: {resources_path}")
                try:
                    contents = os.listdir(resources_path)[:10]
                    console.log(f"📂 Resources contents: {contents}")
                except:
                    console.log("⚠️ Could not list resources directory")
            else:
                console.log(f"❌ Resources path not found: {resources_path}")
    ...
    def _setup_diagram_generators(self):
        ...
        def generate_diagram_1():
            ...
            console.log("🔄 Regenerating diagram 1...")
            try:
                ...
                console.log("✅ Diagram 1 regenerated!")
            except Exception as e:
                console.log(f"❌ Error regenerating diagram 1: {e}")

        def generate_diagram_2():
            """Generate Clustered Web Services diagram."""
            console.log("🔄 Regenerating diagram 2...")
            try:
                ...
                console.log("✅ Diagram 2 regenerated!")
            except Exception as e:
                console.log(f"❌ Error regenerating diagram 2: {e}")

        def generate_diagram_3():
            """Generate Event-Driven Architecture diagram."""
            console.log("🔄 Regenerating diagram 3...")
            try:
                ...
                console.log("✅ Diagram 3 regenerated!")
            except Exception as e:
                console.log(f"❌ Error regenerating diagram 3: {e}")

        def generate_diagram_4():
            """Generate Microservices API diagram."""
            console.log("🔄 Regenerating diagram 4...")
            try:
                ...
                console.log("✅ Diagram 4 regenerated!")
            except Exception as e:
                console.log(f"❌ Error regenerating diagram 4: {e}")

        def generate_diagram_5():
            """Generate Data Analytics Pipeline diagram."""
            console.log("🔄 Regenerating diagram 5...")
            try:
                ...
                console.log("✅ Diagram 5 regenerated!")
            except Exception as e:
                console.log(f"❌ Error regenerating diagram 5: {e}")
        ...
        console.log(f"✅ Registered {len(self.diagram_generators)} diagram generators")
    ...
    def _expose_to_javascript(self):
        ...
        console.log("✅ Diagram generators exposed to JavaScript")
    ...
    def generate_all_diagrams(self):
        ...
        console.log("🐍 Starting initial diagram generation...")
        ...
        console.log("✅ All diagrams sent to JavaScript for rendering")
    ...
    def run(self):
        ...
        console.log("🐍 Initializing DiagramsRenderer workflow...")
        ...
        try:
            ...
            console.log("✅ DiagramsRenderer workflow complete!")
